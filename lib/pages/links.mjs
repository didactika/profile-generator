...
export class Links {
  ...
  /** A fixed-height image avoids inheriting GitHub's <h1> font size. */
  parentAffiliation(locale, label, url) {
    return `<a href="${url}"><picture><source media="(prefers-color-scheme: dark)" srcset="${this.assets}/parent-${locale}-dark.svg"><img alt="${escapeXml(label)}" src="${this.assets}/parent-${locale}-light.svg" height="12"></picture></a>`;
  }
